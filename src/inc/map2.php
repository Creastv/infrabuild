...
wp_add_inline_script( 'map-js', '
    function initMap() {
        ...
        const map = new google.maps.Map(document.getElementById("map"), {
            zoom: ' . json_encode(get_theme_mod('zoom'), JSON_NUMERIC_CHECK) .',
            center: uluru,
        ...
        const contentString =
            `<div id="tooltip-map">
              <p>' . get_theme_mod('inf-address') .'</p>
              <a href="' . get_theme_mod('link-map') . '" target="_blank" class="btn btn-main btn-small">Jak dojadę</a>
            </div>`;
